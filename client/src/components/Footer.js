        ...
        <div className="grid grid-cols-1 gap-6 text-center md:grid-cols-2 lg:flex lg:justify-between lg:items-center">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Link
              ...
              href="#"
              title="Instagram"
              className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 hover:dark:bg-violet-600 dark:text-gray-900"
            >
              <svg
            ...
            <Link
              ...
              to="#"
              title="Pinterest"
              className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-400 hover:dark:bg-violet-600 dark:text-gray-900"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
